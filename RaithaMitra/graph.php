...
$ms1 = mysqli_query($link, "SELECT SUM(price) as price FROM crop_price WHERE crop='sugarcane' AND market='mysore' AND month < 7");
$count = 0;
...
$count = 1;
$ms2 = mysqli_query($link, "SELECT SUM(price) as price FROM crop_price WHERE crop='sugarcane' AND market='mandya' AND month > 6");
...
$ms3 = mysqli_query($link, "SELECT SUM(price) as price FROM crop_price WHERE crop='sugarcane' AND market='mysore' AND month < 7");
$count = 0;
...
$count = 1;
$ms4 = mysqli_query($link, "SELECT SUM(price) as price FROM crop_price WHERE crop='sugarcane' AND market='mandya' AND month >  6");
